package com.redhat.camel.dmzEntity;
...
/**
 * The persistent class for the PTS_SERIAL_NUMBERS_IF2 database table.
 * 
 */
@Entity
@Table(name="PTS_SERIAL_NUMBERS_IF2")
@NamedQuery(name="PtsSerialNumbersIf2.findAll", query="SELECT p FROM PtsSerialNumbersIf2 p")
public class PtsSerialNumbersIf2 implements Serializable {
